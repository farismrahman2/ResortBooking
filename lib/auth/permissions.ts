...
const ALL_MODULES: ModuleSlug[] = ['bookings', 'checkout', 'expenses', 'hr', 'reports', 'settings', 'availability', 'attendance', 'coffee_shop', 'inventory', 'crm', 'fixed_assets', 'qa', 'menus', 'enquiries']

...
const navItems: NavItem[] = [
  ...
  { href: '/qa',           label: 'Guest Feedback', icon: MessageSquareHeart, module: 'qa' },
  ...
  { href: '/kitchen/requisitions', label: 'Kitchen Orders',    icon: ClipboardList, module: 'kitchen' },
  { href: '/kitchen/deliveries',   label: 'Kitchen Deliveries', icon: PackageCheck,  module: 'kitchen' },
  { href: '/kitchen/ledger',       label: 'Supplier Ledger',    icon: Scale,         module: 'kitchen' },
  ...
  { href: '/fixed-assets', label: 'Fixed Assets', icon: Archive,        module: 'fixed_assets' },

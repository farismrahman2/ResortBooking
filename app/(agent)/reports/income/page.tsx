  ...
  return (
    <ReportShell exportReportId="income" title="Income overview" subtitle="Revenue across rooms and extras" period={period} preset={preset} customFrom={customFrom} customTo={customTo} mode={mode}>
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <KpiCard label="Extras revenue" value={formatBDTCompact(current.extras_revenue)} raw={current.extras_revenue} prior={prev?.extras_revenue ?? null} yoy={yoy?.extras_revenue ?? null} mode={effectiveMode} />
      ...
      <ChartCard title="Daily revenue" subtitle="Stacked: rooms vs extras">
